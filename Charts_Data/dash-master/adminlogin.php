		...
		<div class="card-body">
		 <div class="card-content p-2">
		 	<div class="text-center">
		 		<img src="../../images/0logo.png" alt="logo icon" width="50%">
		 	</div>
		    ...
		    <form action="adminchecklogin.php" method="POST">
			  ...
			  <label for="exampleInputUsername" class="sr-only">Usuario</label>
			   <div class="position-relative has-icon-right">
				  <input name="username" type="text" id="exampleInputUsername" class="form-control input-shadow" placeholder="Enter Username">
