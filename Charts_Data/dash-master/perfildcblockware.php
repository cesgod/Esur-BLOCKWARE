     ...
     <div class="col-12 col-lg-12 col-xl-12" style="height: 800px;">
	    <div class="card">
		 <div class="card-header">Perfil de Carga
            <div class="x_title">
                                <h4>Perfil de Carga <small> <?php echo $meterd; echo " Desde: ".$date01." Hasta: ".$date02;  ?></small></h4>
            </div>
		 ...
		 <div class="row m-0 row-group text-center border-top border-light-3">
		   <div class="col-12 col-lg-12">
		     <div class="p-3">
                <div class="updatemax">
                <h5 class="mb-0"></h5>
			        <small class="mb-0">Última Lectura: <span> <i class="fa fa-arrow-up"></i> </span></small>
                </div>
		     </div>
		   </div>
		   <!--<div class="col-12 col-lg-6">
		     <div class="p-3">
		       <h5 class="mb-0"> kW</h5>
			   <small class="mb-0">Maximun Demand Meter 02<span> <i class="fa fa-arrow-up"></i></span></small>
		     </div>
		   </div>-->
...
-->
 ...
 <!-- simplebar js -->
  ...
  <script src="../../dash/meters/client/assets/php/demobw.js"></script>
  <script type="text/javascript">
    function updateTest() {
        $(".updatemax").load("../../dash/meters/client/production/maxdatabw.php");
    }
