  ...
  <ul class="navbar-nav align-items-center right-nav-link">
    ...
    <li class="nav-item">
      <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
        <span class="user-profile"><img src="../../images/logo_clip.png" class="img-circle" alt="user avatar"></span>
      </a>
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="../../images/logo_clip.png" alt="user avatar"></div>
        ...
        <li class="dropdown-item"><i class="icon-power mr-2"><a href="adminlogin.php"></i>Salir</li></a>
      </ul>
    </li>
  </ul>
</nav>
...
<div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Resumen de Consulta de Facturas</h5> 
              ...
              <table class="table table-hover" id="Mytable" class="Mytable">
                ...
                <tbody>
                  <?php
                    ...
                    $database = 'invoice_chart';
                    $cdate= new DateTime('now', new DateTimeZone('America/Asuncion'));
                    $cdtz=$cdate->format('Y/m');
                    $arrayd = array();
                    $query = mysqli_query($conexion, 'SELECT * from '. $database .' ');
                    $cant=0;
                    while ($r = mysqli_fetch_assoc($query)) {
                      $gtimes        = $r['Time_Stamp'];
                      $gtimes        = str_replace('/', '-', $gtimes);
                      $newDateString      = date("Y/m", strtotime($gtimes));
                      #if ($newDateString==$cdtz){
                        $cant=$cant+1;
                        echo '
                          <tr>
                            <td>'.$cant.'</td>
